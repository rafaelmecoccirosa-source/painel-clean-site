...
export default function Footer() {
  ...
  return (
    <footer className="bg-pc-deepest border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-10 mb-10">
          ...
          <div className="flex flex-col gap-4">
            <a href="/" className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-white text-lg">Painel Clean</span>
            </a>
            <p className="text-white/40 font-sans text-sm leading-relaxed max-w-xs">
              Equipamentos profissionais para limpeza de painéis fotovoltaicos. Motor brushless,
              sem químicos, máxima eficiência.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <address className="not-italic text-white/40 font-sans text-sm leading-relaxed">
              Brasil
              <br />
        ...
        <div className="border-t border-white/5 pt-6 text-center text-white/25 font-sans text-xs">
          © {year} Painel Clean. Todos os direitos reservados.
        </div>
      </div>
    </footer>
  )
