...
export default function Nav() {
  const waHref = `https://wa.me/${whatsappNumber}?text=Olá! Gostaria de mais informações sobre os equipamentos Painel Clean.`
    ...
    <header className="sticky top-0 z-50 bg-pc-darker/90 backdrop-blur-md border-b border-white/5">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <a
          ...
          className="flex items-center gap-2 bg-pc-green text-pc-darker font-semibold text-sm px-4 py-2 rounded-lg hover:bg-pc-green/90 transition-colors shrink-0"
        >
          <svg
            className="w-4 h-4"
            viewBox="0 0 24 24"
