    ...
    <section className="bg-pc-mid py-16 md:py-24">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center gap-6">
        ...
        <p className="text-white/55 font-sans text-base leading-relaxed max-w-lg">
          Fale agora com nossa equipe pelo WhatsApp. Respondemos em minutos e te ajudamos
          a escolher o equipamento certo para o seu negócio.
        </p>
        <a
          href={waHref}
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-3 bg-pc-green text-pc-darker font-bold font-sans text-base px-8 py-4 rounded-xl hover:bg-pc-green/90 transition-colors"
        >
